...
const Navbar = () => {
  ...
  return (
    <div className="w-screen flex flex-col iteme-center">
      <nav className="fixed top-[1rem] left-1/2 -translate-x-1/2 w-[90vw] bg-white/30 backdrop-blur-md flex items-center justify-between p-3 border border-sidebar-border rounded-full">
        <div
          onClick={() => navigate("/")}
